...
var ApolloConsumer = function (props) {
  var ApolloContext = getApolloContext();
  return _react.default.createElement(ApolloContext.Consumer, null, function (context) {
    process.env.NODE_ENV === "production" ? (0, _tsInvariant.invariant)(context && context.client, 5) : (0, _tsInvariant.invariant)(context && context.client, 'Could not find "client" in the context of ApolloConsumer. ' + 'Wrap the root component in an <ApolloProvider>.');
